...
class WordSegmentation:
    ...
    def segment(self,image_gray):
        ...
        # image_gray = filters.gaussian(image_gray, 1)
        image_gray = gaussian(image_gray, 1)

        # Thresholding
        image_gray *= 255
        threshold = np.round(threshold_otsu(image_gray) * 1.1)
        # threshold = np.round(filters.threshold_otsu(image_gray) * 1.1)
    ...
    def word_segmentation(self, image, name):
        ...
        # threshold = filters.threshold_otsu(image_binary)
        ...
        # image_gaussian = filters.gaussian(image_binary.copy(), variance) * 255
        ...
        # threshold = filters.threshold_otsu(image_gaussian_binary)
