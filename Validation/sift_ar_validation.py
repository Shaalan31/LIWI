        ...
        for phi_test in phi:
            ...
            for w_test in w:
                ...
                for x in classCombinations:
                    ...
                    sift_model = SiftModel(test_classes=x , code_book=code_book,t=t_test,phi=phi_test,w=w_test,lang='ar')
                    sift_model.run()
                    if accuracy is None:
            ...
            if accuracy_10 is None:
                accuracy_10 = (accuracy[0,:]/accuracy[1,:]).reshape((1,5))
            else:
                accuracy_10 = np.append(accuracy_10,(accuracy[0,:]/accuracy[1,:]).reshape((1,5)),axis=0)
